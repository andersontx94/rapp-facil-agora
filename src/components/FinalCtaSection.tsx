    ...
    <section className="py-20 md:py-28 bg-primary relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Main Headline */}
          <h2 className="font-display text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-white font-bold leading-tight mb-8">
          ...
          <a 
            ...
            className="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-amber-500 to-amber-400 hover:from-amber-400 hover:to-amber-300 text-primary font-bold text-lg md:text-xl px-8 md:px-12 py-5 md:py-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] mb-12"
          >
            <MessageCircle className="w-6 h-6 md:w-7 md:h-7" />
            <span>Falar com especialista da FRTB no WhatsApp</span>
            <ArrowRight className="w-5 h-5 md:w-6 md:h-6" />
          </a>

          {/* Trust Points */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 pt-8 border-t border-white/10">
