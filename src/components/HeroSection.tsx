...
const HeroSection = () => {
  return <section className="relative min-h-screen gradient-hero flex items-center">
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="heading-display text-4xl md:text-5xl lg:text-6xl text-foreground mb-6 leading-tight">
            ...
            <span className="text-accent">Prazo: 31 de março
Sua empresa é obrigada a entregar o RAPP ao IBAMA?
O prazo está acabando.

O prazo vai até 31 de março. Quem não entrega pode ser multado e ter o CTF bloqueado. A FRTB cuida de tudo: levantamento, documentação e protocolo no IBAMA.

Resolver meu RAPP agora no WhatsApp
Atendimento ágil
Responsabilidade técnica
Atuação em todo Brasil</span> ao IBAMA?{" "}
          ...
          {/* CTA Button */}
          <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="btn-whatsapp text-base md:text-lg">
