    ...
    <section className="py-16 md:py-20 gradient-hero relative overflow-hidden">
      ...
      <div className="container mx-auto px-5 md:px-4 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Main content */}
          <div className="bg-card border border-border rounded-xl p-6 md:p-10 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <p className="text-body text-sm md:text-lg text-foreground leading-relaxed mb-5 md:mb-6 px-1">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4 mb-5 md:mb-6">
                <div className="flex items-start gap-3 p-3 md:p-4 bg-muted/30 border border-border rounded-lg">
                  <Shield className="w-4 h-4 md:w-5 md:h-5 text-accent mt-0.5 flex-shrink-0" />
                  <span className="text-body text-xs md:text-sm text-foreground leading-tight">Trabalho técnico e criterioso</span>
                </div>
                <div className="flex items-start gap-3 p-3 md:p-4 bg-muted/30 border border-border rounded-lg">
                  <Target className="w-4 h-4 md:w-5 md:h-5 text-accent mt-0.5 flex-shrink-0" />
                  <span className="text-body text-xs md:text-sm text-foreground leading-tight">Foco na segurança da sua empresa</span>
                </div>
                <div className="flex items-start gap-3 p-3 md:p-4 bg-muted/30 border border-border rounded-lg">
                  <FileCheck className="w-4 h-4 md:w-5 md:h-5 text-accent mt-0.5 flex-shrink-0" />
                  <span className="text-body text-xs md:text-sm text-foreground leading-tight">Experiência prática com demandas do IBAMA</span>
                </div>
                <div className="flex items-start gap-3 p-3 md:p-4 bg-muted/30 border border-border rounded-lg">
                  <Scale className="w-4 h-4 md:w-5 md:h-5 text-accent mt-0.5 flex-shrink-0" />
                  <span className="text-body text-xs md:text-sm text-foreground leading-tight">Conformidade com a legislação vigente</span>
                </div>
              </div>

              <div className="bg-accent/10 border border-accent/20 rounded-lg p-4 md:p-6 text-center">
                <p className="heading-display text-sm md:text-lg text-foreground leading-relaxed">
