      ...
      <div className="container mx-auto px-5 md:px-4 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-background border border-border rounded-xl p-6 md:p-10">
            ...
            <p className="text-body text-base md:text-lg text-foreground text-center mb-6 md:mb-8 leading-relaxed px-2">
            ...
            <div className="bg-muted/50 border border-border rounded-lg p-4 md:p-6">
              <p className="heading-display text-base md:text-xl text-center text-foreground leading-relaxed">
